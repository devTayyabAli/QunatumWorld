...
export default function Forgat_Password() {
    ...
    const onSubmitHandler = async (data) => {
        ...
        let res = await API.post('/forgetpassword_new',
            {
                "uid":data.uid
            }
        ...
        if (res == undefined) {
            ...
            } else if(res.data.data=="Correct User ID !!") {
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6">
                                            ...
                                            <center>
                                            <img src={horse} alt="shape-image" class="img-fluid w-80"  style={{width:'300px'}}/>
                                            </center>
                                            ...
                                            <form class="login-signup-form form-signin mt-5" onSubmit={handleSubmit(onSubmitHandler)}>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <label className='co'>Enter Your User ID</label>
                                                            <input type="num" class="inpu floating-input form-control" name="uid" id="uid"  {...register("uid", { required: true })} />
                                                ...
                                                <button type="submit" class="buton btn btn-primary" value="1" id="dloginshine" name="submitRegisterMember" > {spinnerload ? (<><div class="spinner-border" role="status">
